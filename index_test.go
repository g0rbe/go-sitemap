...
func TestIndex(t *testing.T) {
	...
	i1 := sitemap.NewIndex(
		sitemap.NewURL(sitemap.NewLoc("https://example.com/"), sitemap.NewLastMod("2024-01-01"), nil, nil),
		sitemap.NewURL(sitemap.NewLoc("https://example.com/one"), sitemap.NewLastMod("2024-01-02"), nil, nil),
		sitemap.NewURL(sitemap.NewLoc("https://example.com/two"), sitemap.NewLastMod("2024-01-03"), nil, nil),
	)
